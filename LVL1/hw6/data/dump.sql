...
CREATE TABLE `review_list` (
	...
	FOREIGN KEY(rewiew_id) REFERENCES `review_item`(id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
INSERT INTO `review_item` (name, textReview)
VALUES ('Валера', 'хорошая игра'), ('Анна', 'Очень умиротворяющая атмосфера'), ('Екатерира', 'Классная музыка'), ('Александр', 'Отличная чигра чтобы расслабиться');

INSERT INTO `review_list` (item_id, rewiew_id)
